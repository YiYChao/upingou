...
import top.upingou.mapper.TbContentMapper;
import top.upingou.pojo.TbContent;
import top.upingou.pojo.TbContentExample;
import top.upingou.pojo.TbContentExample.Criteria;
...
public class ContentServiceImpl implements ContentService {
	...
	public List<TbContent> findByCategoryId(Long categoryId) {
		...
		if(contentList == null) {
			...
			contentList = contentMapper.selectByExample(example);	// 获广告列表
